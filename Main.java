...
//Note don't give java or main , m in lowercase because main is there in public static 
// NOTE you can import the package only from the parent directory
public class Main {
    ...
    public static void main(String[] args) {
       ...
       /*  Teacher t1= new Teacher("oops",32,100);
        ...
        //with password
        // Teacher t2= new Teacher("Abhi",20,7,"nothing");
        // t2.Display();
        Student s2= new Student("abhi",07,99,"abc");
        // Student s2= new Student("abhi",07,99,"xyz"); 
        /*you can't make change in the same object therefore you need getter and setter
